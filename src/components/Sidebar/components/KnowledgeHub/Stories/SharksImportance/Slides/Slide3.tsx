    ...
    >
      ...
      <div className="relative z-10 h-full justify-center flex flex-col items-center text-center px-8 ">
        ...
        >
          ...
          <TextWithSpeech textToRead="Check out the image above to see how a food chain works in marine ecosystems. This diagram shows the complex relationships between different organisms, from tiny seagrass to apex predators like sharks." />
        </motion.p>
      </div>
      {/* Navigation buttons */}
